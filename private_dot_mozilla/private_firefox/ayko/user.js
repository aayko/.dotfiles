...
// PREF: Play DRM content
user_pref("media.eme.enabled", true);

// PREF: Restore previous windows and tabs
...
// PREF: Same search engine for private windows
user_pref("browser.search.separatePrivateDefault.ui.enabled", false);

// PREF: Hide bookmarks toolbar
user_pref("browser.toolbars.bookmarks.visibility", "never");

// PREF: Do not prompt for translate
user_pref("browser.translations.automaticallyPopup", false);

// PREF: Send a do not track request
user_pref("privacy.donottrackheader.enabled", true);

// PREF: Hide firefox suggest
user_pref("browser.urlbar.groupLabels.enabled", false);

// PREF: Maximum of 6 history entries in adress bar
user_pref("browser.urlbar.maxRichResults", 6);

// PREF: Disable some suggested stuff in adress bar
user_pref("browser.urlbar.suggest.openpage", false);
user_pref("browser.urlbar.suggest.engines", false);
user_pref("browser.urlbar.suggest.topsites", false);

// PREF: Use default dns provider
user_pref("network.trr.mode", 5);

// PREF: Disable picture in picture controls
